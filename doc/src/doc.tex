...
\begin{figure}
 \centering
    \subfloat{{\includegraphics[width=7cm]{cam_loc_l.jpg} }}%
    \qquad
    \subfloat{{\includegraphics[width=7cm]{cam_loc_l2.jpg} }}%
...
\begin{figure}
 \centering
    \subfloat{{\includegraphics[width=7cm]{cam_loc_r.jpg} }}%
    \qquad
    \subfloat{{\includegraphics[width=7cm]{cam_loc_r2.jpg} }}%
...
\begin{figure}
 \centering
    \subfloat{{\includegraphics[width=7cm]{cam_loc.jpg} }}%
    \qquad
    \subfloat{{\includegraphics[width=7cm]{cam_loc2.jpg} }}%
