function lines_out = select_lines(lines,img, text, auto_selection, line_group)
...
if (auto_selection)
    switch line_group
        ...
        case LINES_LONG_RIGHT
            line_indices = [39 4 24 13 65];
        case LINES_SHORT_LEFT
            line_indices = [15 31 55];
        case LINES_SHORT_RIGHT
            line_indices = [62 33 68];
        case LINES_GROUND
            line_indices = [10 16 19 50];
        case LINES_VERTICAL
            line_indices = [26 6 9 5 12 45 35 30 49];
